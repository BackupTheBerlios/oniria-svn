/* $Id: cptMD5.cc 624 2006-01-01 22:04:34Z choman $ */
/*
 * Copyright (C) 2005
 *
...
bool cptMD5::update(const QString& msg)
{
	QByteArray tmp;
	tmp = msg.toLocal8Bit();
	return update(reinterpret_cast<const uint8_t *>(tmp.data()), tmp.size());
}
